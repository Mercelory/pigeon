...
const Register = () => {
  ...
  return (
    <section className="flex bg-linear-to-r from-slate-200 to-white">
      ...
      <form onSubmit={handleRegister} className="flex flex-col w-1/5">
        <input
          type="text"
      ...
      <div className="border-1 border-slate-300 w-1/5 mt-5"></div>
      <a href='#' className="bg-slate-200 w-1/5 flex justify-start items-center mt-5 h-12 rounded-md p-2 text-slate-500"><TbBrandGoogle className="text-3xl font-bold mr-3 text-slate-400"/>Sign in via Google</a>
    </div>
