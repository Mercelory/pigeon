...
function MessageInLeftSide() {
  return (
    <div className="w-[90%] flex md:flex-col gap-2 overflow-scroll">
      <a href = '#' className="relative">
    <ul className="flex flex-wrap items-center rounded-lg p-1 transition-transform duration-800 hover:bg-neutral-100">
